...
var RESPONSES = [
		[ undefined, [
			...
			/(гея )?(ищ[ую]|хочу) ([мжпд] |[мжпд]$|би |парня|девушку|девочку|лезби|девчонку|женщину|даму|горячую|полненькую|послушн|взросл|зрелую|сочную|суч?ку|раба|гея|господина|лесби|подругу|строгую|прекрасн|похотлив|собеседницу|нижнюю|милого)/i,
			...
			/^покажи/i, /пока(жи|жите|зать)? *(себя|свою|свои|лицо|груд[ьи]|трус)/i, / фото([ .?)☺️!$]|чк)/i, /фотк/i, /фото$/i,
			/покажи свои/i,
			...
			/^(ты )?откуда/i,
			/^(привет[., ])?(я )?(макс|егор|влад|боря|дмитрий|ваня|вова|стас|игорь|дима|витя|илья|алексей|олег|валентин|георгий|арсений|миша|андрей|рома|вася|коля|александр|кирилл|гоша|дани+л|никита|костя|сергей)/i,
			/^(привет[., ])?(я )?(лиза|алина|наст[яь]|маша|наташа)/i,
			/^(спб|екб|мск|питер|москва|новосиб|киев|магнитогорск|казахстан|воркута)/i,

			/https?:/i,
			/^мур( мур)?[:3 ]*$/i, /^мяу$/i, /^гоу? /i, /^(лол|кек)/i, /кис кис кис/i,
			...
			/ставить точк./i, /^с точкой/i, /много точек/i, /точка в конце/i,
			...
			/Харли Квин/i, /ТОЛЬКО ВМЕСТЕ МЫ СИЛЬНЫ/i, /дратути/i, /^дч[?]*$/i, /^девчат$/i, /нико.нико.ни/i, /pidrilina/i,
			/ты не шаришь/i
		]	],
		[ 'Здравствуй.', [
			/^Приветствую.?$/i
		...
		[ 'Привет.', [
			/^[.]*(пр+и+в+[еэі]+[тиь].?|прив)[ ^?;:.30)!сc]*(собеседник)?$/i, /^привте$/i, /^приветики?[ :з)]?$/i, /^привки$/i,
			/^х[аеэ]+й.?$/i,
		...
		[ 'Хорошо. И у тебя.', [
			/^как (дела+|жизнь|жиза|настроени[ея])[?) \\]*$/i
		]	],
		[ 'Спокойно. А у тебя?', [
