...
var RESPONSES = [
		[ undefined, [
			...
			/^(ты )?откуда/i,
			/^(привет[., ])?(я )?(макс|влад|боря|дмитрий|игорь|дима|витя|алина|наст[яь]|алексей|олег|валентин|георгий|миша|андрей|маша|наташа|рома|вася|коля|александр|кирилл|гоша|дани+л|никита|костя|сергей)/i,
