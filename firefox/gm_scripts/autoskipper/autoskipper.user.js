...
var RESPONSES = [
		[ undefined, [
			...
			/^(ты )?откуда/i,
			/^(привет[., ])?(я )?(макс|егор|влад|боря|дмитрий|вова|стас|игорь|дима|витя|алина|наст[яь]|илья|алексей|олег|валентин|георгий|арсений|миша|андрей|маша|наташа|рома|вася|коля|александр|кирилл|гоша|дани+л|никита|костя|сергей)/i,
