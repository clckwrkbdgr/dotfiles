...
var RESPONSES = [
		[ undefined, [
			...
			/(ищ[ую]|хочу) ([мжпд] |[мжпд]$|би |парня|девушку|девочку|девчонку|женщину|даму|горячую|полненькую|послушн|взросл|зрелую|суч?ку|раба|гея|господина|лесби|подругу|строгую|прекрасн|похотлив|собеседницу|нижнюю|милого)/i,
			...
			/показать.*голой/i, /^чуд. /i, /Привет! Я парень./i,
			...
			/^гк[,.)!?]*$/i, /^гк /i, /курлык/i, /биллдип/i, /сосенка/i, /чудо вокруг/i, /иван *гай/i, /бабулька/i, /лучший футболист/i, /ирландские попки/i,
			/ты не шаришь/i
		]	],
		[ undefined, [
