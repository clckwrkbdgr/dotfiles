...
var RESPONSES = [
		[ undefined, [
			...
			/(гея )?(ищ[ую]|хочу) ([мжпд] |[мжпд][)]*$|би |парня|девушку|девочку|лезби|девчонку|женщину|даму|горячую|полненькую|послушн|взросл|зрелую|сочную|суч?ку|раба|гея|господина|лесби|подругу|строгую|прекрасн|похотлив|собеседницу|нижнюю|милого|милую|сладенькую|плохую|опытную|казашек|пассива|приятную|хозяина|отбит|пышную)/i,
			...
			/(возможно|Если) ты девушка/i, /Я Zotic/i,
			...
			/Расскажи что-нибудь интересное/i, /не молчи/i, /(писос )?скучно$/i, /молчишь[?]*$/i,
			...
			/Не уходи смиренно, в сумрак вечной тьмы/i, /ищу енота в гусси/i, /Добрейш[^ ]+ вечероч/i,
			/ты не шаришь/i
		]	],
