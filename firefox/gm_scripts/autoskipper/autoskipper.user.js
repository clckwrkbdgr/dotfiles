...
var RESPONSES = [
		[ undefined, [
			...
			/^(ты )?откуда/i,
			/^(привет[., ])?(я )?(макс|егор|влад|боря|Олег|Кристина|дмитрий|ваня|вова|стас|игорь|дима|витя|илья|алексей|олег|валентин|георгий|арсений|миша|андрей|рома|вася|коля|александр|кирилл|гоша|дани+л|никита|костя|сергей)/i,
