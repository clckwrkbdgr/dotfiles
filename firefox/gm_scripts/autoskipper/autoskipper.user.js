...
var RESPONSES = [
		[ undefined, [
			...
			/^(ты )?откуда/i,
			/^(привет[., ])?(я )?(макс|Макс|егор|влад|боря|вадим|иван|дима|Олег|денис|саня|сергей|павел|евгений|дмитрий|ваня|вова|стас|игорь|дима|витя|илья|алексей|артем|валентин|георгий|арсений|миша|андрей|рома|вася|коля|николай|александр|кирилл|гоша|дани+л|Никита|костя|сергей|паша|михаил)/i,
				/Привет, я Макс/i,
			/^(привет[., ])?(я )?(лиза|алина|наст[яь]|маша|наташа|Кристина|юля|вика|яна|лера|мария)/i,
			...
			/^(gold|голд+)$/i, /Мюсли захватят мир/i,
			/ты не шаришь/i
		]	],
