...
var RESPONSES = [
		[ undefined, [
			...
			/(гея )?(ищ[ую]|хочу) ([мжпд] |[мжпд]$|би |парня|девушку|девочку|девчонку|женщину|даму|горячую|полненькую|послушн|взросл|зрелую|сочную|суч?ку|раба|гея|господина|лесби|подругу|строгую|прекрасн|похотлив|собеседницу|нижнюю|милого)/i,
			...
			/грудью/i, /прелести/i, /сис(и|ями|ьки|ечки|ек|ька)/i, /тит(ечки|ьки)/i, /письк/i, /скинь груд/i,
			/^покажи/i, /пока(жи|жите|зать)? *(себя|свою|свои|лицо|груд[ьи]|трус)/i, / фото[ .?)☺️!$]/i, /фотк/i, /фото$/i,
			/покажи свои/i,
			...
			/^(ты )?откуда/i,
			/^(привет[., ])?(я )?(макс|влад|боря|дмитрий|игорь|дима|витя|алина|наст[яь]|илья|алексей|олег|валентин|георгий|арсений|миша|андрей|маша|наташа|рома|вася|коля|александр|кирилл|гоша|дани+л|никита|костя|сергей)/i,
