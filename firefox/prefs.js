...
user_pref("browser.pageActions.persistedActions", "{\"version\":1,\"ids\":[\"bookmark\",\"bookmarkSeparator\",\"copyURL\",\"emailLink\",\"sendToDevice\",\"screenshots\",\"pinTab\",\"addSearchEngine\",\"screenshots_mozilla_org\"],\"idsInUrlbar\":[]}");
...
user_pref("browser.startup.lastColdStartupCheck", 1573190523);
...
user_pref("services.settings.last_update_seconds", 1573363351);
...
user_pref("services.settings.main.hijack-blocklists.last_check", 1573190550);
user_pref("services.settings.main.language-dictionaries.last_check", 1573190550);
user_pref("services.settings.main.sites-classification.last_check", 1573190550);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1573190550);
user_pref("services.settings.security.onecrl.checked", 1573190550);
