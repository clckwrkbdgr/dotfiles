...
class TestMazeDungeon(unittest.TestCase):
	def should_generate_maze(self):
		...
		builder.add_cell_type('floor', ".")
		builder.build()
		self.assertEqual(builder.start_pos, Point(73, 3))
		self.assertEqual(builder.exit_pos, Point(51, 11))
		self.maxDiff = None
		expected = textwrap.dedent("""\
				################################################################################
				#.#.......#.......#.........#...#.....#...#...#...#...#.........#...#.........##
	...
	def should_generate_maze_without_hanging(self):
		...
		builder.add_cell_type('floor', ".")
		builder.build()
		self.assertEqual(builder.start_pos, Point(28, 15))
		self.assertEqual(builder.exit_pos, Point(35, 15))
		self.maxDiff = None
		expected = textwrap.dedent("""\
				################################################################################
				#.....#.......#...............#...#.#.....#...............................#...##
...
class TestSewers(unittest.TestCase):
	def should_generate_sewers_maze(self):
		...
		builder.add_cell_type('wall', '#')
		builder.add_cell_type('floor', ".")
		builder.add_cell_type('water', "~")
		builder.build()
		self.maxDiff = None
		self.assertEqual(builder.start_pos, Point(55, 1))
		self.assertEqual(builder.exit_pos, Point(35, 21))
		expected = textwrap.dedent("""\
				################################################################################
				#............####............................####....................####....###
				#.~~~~~~~~~~.####.~~~~~~~~~~~~~~~~~~~~~~~~~~.####.~~~~~~~~~~~~~~~~~~.####.~~.###
