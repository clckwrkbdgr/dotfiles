...
class TaskScheduler: # pragma: no cover -- TODO calls external command and available on win only.
	...
	class Trigger:
		Repetition = namedtuple('Repetition', 'interval duration stop_at_duration_end')
		...
		IdleTrigger = namedtuple('IdleTrigger', 'id enabled repetition execution_time_limit')
		...
		LogonTrigger = namedtuple('LogonTrigger', 'enabled delay repetition user_id start_boundary end_boundary execution_time_limit')
		...
		SessionStateChangeTrigger = namedtuple('SessionStateChangeTrigger', 'enabled state_change user_id execution_time_limit delay')
