...
class Generator: # pragma: no cover -- TODO relies on built-in module `random`. Needs mocks.
	...
	def original_rogue_dungeon(self, map_size, grid_size,
		...
		class _Dungeon(clckwrkbdgr.pcg.rogue.Dungeon):
			...
			MAX_TUNNEL_ETCHING_TRIES = max_tunnel_etching_tries
		builder = _Dungeon(map_size, grid_size, min_room_size)

		result = SimpleNamespace()
		result.rooms = builder.grid
		result.tunnels = builder.tunnels
